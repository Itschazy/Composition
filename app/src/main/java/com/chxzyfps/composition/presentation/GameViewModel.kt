...
import com.chxzyfps.composition.domain.usecases.GenerateQuestionUseCase
import com.chxzyfps.composition.domain.usecases.GetGameSettingsUseCase
...
class GameViewModel(application: Application) : AndroidViewModel(application) {
    ...
    val enoughPercentOfRightAnwers: LiveData<Boolean>
    ...
    private fun finishGame() {
        _gameResult.value = GameResult(
            enoughCountOfRightAnswers.value == true && enoughPercentOfRightAnwers.value == true,
            countOfQuestions,
            countOfRightAnswers,
            gameSettings
        )
